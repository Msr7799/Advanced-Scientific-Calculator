...
import { AppState, AppAction, VariableEntry, ConstantEntry } from "@/types/app";
...
function appReducer(state: AppState, action: AppAction): AppState {
  ...
  switch (action.type) {
    ...
    case "DELETE_FORWARD": {
      ...
      if (cursorIndex >= expression.length) return state;
    ...
    case "UPDATE_VARIABLE":
      ...
      return {
        ...
        variables: state.variables.map((variable) =>
          ...
          variable.id === action.payload.id ? { ...variable, name: action.payload.name, value: action.payload.value } : variable
