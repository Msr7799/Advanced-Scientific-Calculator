  ...
  return (
    <div className="relative shrink-0">
      <button
        ...
        style={{ borderLeft: "1px solid var(--border)", fontSize: 11 }}
        title="History"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ background: "var(--surface-1)", borderLeft: "1px solid var(--border)", zIndex: 50 }}
          >
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          background: showExpanded ? "var(--accent-soft)" : "var(--surface-2)",
          color: showExpanded ? "var(--accent)" : "var(--text-subtle)",
          border: "1px solid var(--border-strong)",
          fontSize: 14,
      ...
      <div className="relative flex-1 flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span style={{ color: "var(--border-strong)", fontSize: 9, fontFamily: "monospace", letterSpacing: "0.25em" }}>
              MOVE
            </span>
            {/* Right dots */}
            <div className="flex gap-1.5">
...
function InfoCard() {
  ...
  return (
    ...
    >
      ...
      <div
        className="border-b"
        style={{ borderColor: "var(--border)", background: "var(--surface-2)", padding: "10px 20px" }}
      >
        <span
      ...
      <div style={{ padding: "12px 20px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
        <div className="flex items-center justify-between">
          <span style={{ color: "var(--text-muted)", fontSize: 14, fontWeight: 600 }}>Angle</span>
          <button
        ...
        <div className="flex items-center justify-between">
          <span style={{ color: "var(--text-muted)", fontSize: 14, fontWeight: 600 }}>Memory</span>
        ...
        <div className="flex items-center justify-between">
          <span style={{ color: "var(--text-muted)", fontSize: 14, fontWeight: 600 }}>Ans</span>
      ...
      <div style={{ borderTop: "1px solid var(--border)", padding: "10px 20px 14px", display: "flex", flexDirection: "column", gap: 6 }}>
        {[
          ...
          <div key={key} style={{ fontSize: 12, color: "var(--text-subtle)" }}>
        ...
        {recent.length === 0 ? (
          ...
          recent.map((entry) => (
            <div
              ...
              style={{ background: "var(--surface-2)", border: "1px solid var(--border)", padding: "10px 14px" }}
            >
              <div
...
function ExpandedDisplay({ mode, onClose, onFullscreen, onMenu }: {
  mode: CasioMode;
  onClose: () => void;
  onFullscreen: () => void;
  onMenu: () => void;
  ...
  const isCalculatorDisplay = mode === "RUN_MAT";
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          <button type="button" onClick={onMenu} className="mode-icon-button" title="Open main menu" aria-label="Open main menu">
            <LayoutGrid size={15} />
          </button>
      ...
      {/* Large LCD */}
      <div className="expanded-display-content flex min-h-0 flex-1 overflow-hidden">
        {mode === "MENU" ? (
          <CasioMenuScreen
            displaySize="expanded"
            keyboardNavigation={false}
            onSelect={(selectedMode) => useCasioStore.getState().setMode(selectedMode)}
          />
        ) : isCalculatorDisplay ? (
          <CasioScreen
      ...
      >
        ...
        <span style={{ color: "#2a4060", fontSize: 11, fontFamily: "monospace" }}>
          {mode === "MENU" ? "Main menu / select a workspace" : isCalculatorDisplay ? "Live mirror of calculator display" : `${meta.label} workspace / maximize for full screen`}
        </span>
      </div>
    </motion.div>
  );
      ...
      <AnimatePresence>
        {fullscreenMode && fullscreenMode !== "RUN_MAT" && fullscreenMode !== "MENU" && (
          <motion.div
            ...
            className="fullscreen-workspace fixed inset-0 z-[100] flex flex-col overflow-hidden"
          >
            <div className="fullscreen-header flex items-center border-b pr-3">
              ...
              <ThemeTogglerButton className="ml-2" />
            </div>
